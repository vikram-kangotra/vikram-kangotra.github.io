...
export default function InterestCard({heading, subheading, imageSrc, className}) {
    return (
        <div className={`flex flex-col content-start items-start p-8 bg-dark overflow-visible justify-start justify-self-center content-start flex-nowrap self-center rounded-lg gap-5 h-full ${className}`}>
