export default function HeroButton({link, bgColor, textColor, children}) {
    return (
        <a href={link} className={`relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-{textColor} transition duration-300 ease-out border-2 border-slate-500 rounded-full shadow-md group`}>
