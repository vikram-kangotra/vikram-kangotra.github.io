        ...
        <div className="flex flex-col items-center justify-start p-20 overflow-hidden">
            <div className="flex flex-col items-start content-start justify-start max-w-4xl">
                <div className="pt-6 my-auto text-center space-y-4">
                    <div>
                        <p className="mb-3 text-lg font-semibold tracking-wide text-gray-700 md:text-3xl dark:text-gray-200">
                            Greetings, tech adventurer! <br/>Welcome to my domain where coding and Linux collide.</p>
                        <p className="italic font-medium text-md md:text-lg">
                            I&apos;m a software developer fueled by a love for coding and Linux. 
                            <br/>Every now and then I 
                            <del className="px-1 text-white line-through bg-red-600 dark:bg-red-600"> break</del>
                            <ins className="px-1 text-white bg-blue-800 dark:bg-blue-600"> tinker</ins> 
                            my linux machine. <br/> Sharing experiences and insights through writing.
                        </p>
                    </div>
