    ...
    return (
        <Link href={href} className="transition-transform duration-500 ease-in-out transform hover:scale-100 scale-90">
            <div className='relative overflow-hidden border border-quaternary rounded-xl group md:rounded-3xl'>
                ...
                <span className={`absolute inset-0 flex items-center justify-center w-full h-full md:text-white duration-300 translate-y-5 md:translate-y-full md:group-hover:translate-y-0 ease text-2xl md:text-4xl text-bold`}>
                    {projectName}
                </span>
