...
This configuration ensures that Rust generates code compatible with the WebAssembly platform, paving the way for the seamless integration of Rust modules into VLC's codebase.
